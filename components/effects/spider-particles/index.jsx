      ...
      <div className="absolute inset-0 z-10 pointer-events-none flex flex-col justify-between p-10">
        ...
        <div className="flex items-start pt-1 justify-between">
          <div className="flex flex-col gap-1.5">
            <div className="flex items-center gap-2 max-xl:hidden">
              ...
              <h1 className="mt-0 mb-0 text-4xl font-light text-white/90 tracking-wider leading-none text-left">
                <HyperText>D364©</HyperText>
              </h1>
              <p className="-mt-1 text-md text-white/30 text-left leading-none">
                See The Unseen.
              </p>
            </div>
          </div>
        ...
        <div className="flex items-end justify-between max-xl:hidden ">
          <div className={`transition-opacity duration-700 ${active ? "opacity-0" : "opacity-40"}`}>
              <HyperText className="text-sm font-extralight italic">Scroll Down to explore</HyperText>
